...
| Automatic Review after every PR update | Necessary gate; full-range repetition after bounded fixes is wasteful | Keep the mandatory gate; the recoverable runner defaults to incremental coverage after an assessed review and requires explicit full escalation for high-impact or uncertain changes |
